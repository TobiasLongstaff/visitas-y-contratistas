    ...
    <div class="container">
        ...
        <div class="container-egreso-de-visitas">
            ...
            <form method="post" id="form-egreso-de-visitas" class="container-info-egreso-de-visita" style="--delay: .6s">
                ...
                <div class="container-info-visita" id="container-info-visita">
                </div> 
                <input type="submit" class="btn-acceder" value="Egresar Visita">              
            </form>
        </div>
    </div>
</body>
...
<script src="assets/scripts/egreso-de-visitas.js"></script>
<?php
